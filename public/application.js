...
var appEvents = __webpack_require__(4);
...
var geolib = __webpack_require__(5);
var marks = __webpack_require__(6);
...
var getPosition = function getPosition() {
  ...
  navigator.geolocation.getCurrentPosition(function (position) {
    ...
    var answer = geolib.getRhumbLineBearing( // extend to use marks from marks.js
    { latitude: boatPos.lat, longitude: boatPos.long }, { latitude: markPos.lat, longitude: markPos.long });
    console.log('show me potato salad', answer);
    $('#markBearing').html(Math.round(answer));

    var answer2 = geolib.getRhumbLineBearing({ latitude: boatPos.lat, longitude: boatPos.long }, { latitude: markPos2.lat, longitude: markPos2.long });
...
// Testing
var calculateBearing = function calculateBearing() {
  var p1 = {
    x: -33.899928,
    y: 18.463339
  };
  ...
  var answer = geolib.getRhumbLineBearing({ latitude: "33° 53' 31\" S", longitude: "081° 28' 8\" E" }, { latitude: "33° 52' 32\" S", longitude: "018° 25' 8\" E" });
  console.log(answer);
};
...
var setMarkInfo = function setMarkInfo() {
  console.log('sup cracker');
  var courseToMake = geolib.getRhumbLineBearing({ latitude: markPos.lat, longitude: markPos.long }, { latitude: markPos3.lat, longitude: markPos3.long });

  var distanceToMark = geolib.getDistance({ latitude: markPos.lat, longitude: markPos.long }, { latitude: markPos3.lat, longitude: markPos3.long });

  var twa = courseToMake - inputTwd;

  var distanceAsNm = (distanceToMark / 1852).toFixed(2);
